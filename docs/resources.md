    ...
    <div class="pl-panel">
        ...
        <p>&nbsp;</p>
            <div class="col-sm-12 col-lg-12">
               ...
               <a href="https://github.com/nicholas-b-carter/usptostrap-sass-gulp/tree/gh-pages/resources/" class="btn btn-primary"><i class="icon icon-inverse icon-download"></i> &nbsp;Download USPTO Axure Widget Library</a>
